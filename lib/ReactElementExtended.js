...
function buildProps(props) {
  ...
  applyStyles(builtProps, props.styles, 0, null, helperObj.maxOverridesLength, helperObj.hasPseudoClass);
  return builtProps;
}
...
ReactElement.createElement = function(type, props) {
  ...
  return originalCreateElement.apply(this, [type, props].concat(slice.call(args, 2)));
};
